...
@Entity(name = "AdvertisingAgencyBrandevaluation")
@Table(schema = "\"generated_app\"", name = "\"AdvertisingAgencyBrandevaluation\"")
@Data
public class AdvertisingAgencyBrandevaluation{
