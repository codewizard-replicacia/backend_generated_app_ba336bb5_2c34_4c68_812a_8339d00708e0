...
@Entity(name = "AdvertisingAgencyCompetitorAnalysis")
@Table(schema = "\"generated_app\"", name = "\"AdvertisingAgencyCompetitorAnalysis\"")
@Data
public class AdvertisingAgencyCompetitorAnalysis{
